...
T = TypeVar('T', bound='ProductCategory')


class ProductCategoryRuleSet(str, Enum):
    physical_asset = "physical_asset"
    logical_asset_with_financial_data = "logical_asset_with_financial_data"
    logical_asset_without_financial_data = "logical_asset_without_financial_data"
    server = "server"
    software = "software"
    software_distribution_package = "software_distribution_package"

    def __str__(self):
        return self.value


class ProductCategory(JsonSerializableDict):
    # https://developer.xurrent.com/v1/product_categories/
    __resourceUrl__ = 'product_categories'
    ...
    def __init__(self,
        ...
        self.name = name
        self.group = group
        self.rule_set = ProductCategoryRuleSet(rule_set) if rule_set else None
    ...
    def __str__(self) -> str:
        return (f"ProductCategory(id={self.id}, name={self.name}, group={self.group}, "
                f"rule_set={self.rule_set}, disabled={self.disabled})")
    ...
    @classmethod
    def get_product_categories(cls, connection_object: XurrentApiHelper,
    ...
    def update(self, data: dict) -> T:
        ...
        return ProductCategory.from_data(self._connection_object, response)
